...
vim.keymap.set('n', '<S-F11>', dap.step_out, { desc = "[D]AP: Step O[u]t" })
-- F22 == S-F10
vim.keymap.set('n', '<F22>', dap.run_to_cursor, { desc = "[D]AP: Run to [C]ursor" })
vim.keymap.set('n', '<S-F10>', dap.run_to_cursor, { desc = "[D]AP: Run to [C]ursor" })
vim.keymap.set('n', '<F5>', dap.continue, { desc = "[D]AP: [G]o" })
-- F17 == S-F5
vim.keymap.set('n', '<F17>', dap.terminate, { desc = "[D]AP: Close" })
vim.keymap.set('n', '<S-F5>', dap.terminate, { desc = "[D]AP: Close" })
